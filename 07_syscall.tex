...
\item MS DOS "--- int 0x21, \textcolor{clFadedText}{int 0x20 (завершение программы), int 0x29 (печать символа), \mbox{int 0x2E} (выполнение команды);}

\item Windows NT/2000/XP/2003/Vista  "--- int 0x2E;

\item Windows XP/7/8  "--- sysenter/sysexit \mbox{(syscall  в~64-битной).}
...
\\
от 7 "--- структура, адрес в~\lstinline!%ebx!

результат в~\lstinline!%eax!

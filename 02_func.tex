...
\item \textterminblue{Сохранение адреса возврата}
\item \textterminblue{Передача управления вызываемой подпрограмме}
% \item Выполнение вызываемой подпрограммы
\item Подготовка возвращаемого значения
\item \textterminblue{Возвращение управления вызывающей программе}
\end{enumerate}
\end{frame}

...
\lstinline!movl $0xCCCCCCCC, %ecx! $\to$ \lstinline!B9 CC CC CC CC! 
(объектные файлы)

\includegraphics[width=1\linewidth,height=0.7\slideheight,keepaspectratio,valign=t]{cmd_structure_color}\centering
...
\lstinline!call _Z3fooi! $\to$ \lstinline!call адрес! 
...
\setlength{\leftmargini}{0ex}
\begin{enumerate}
\item Представьте число $19$ в~двоичном виде.
\item Представьте число $19$ в~шестнадцатеричном и~восьмеричном виде.
\item Представьте число $-3$ в~дополнительном коде.
% \item Рассчитайте $19 + (-3)$.
% \item Рассчитайте $3 \And (-2)$.
% \item Рассчитайте $5 \Or 3$.
% % \item Рассчитайте $-\~$.
\item Представьте число $-3$ в~дополнительном коде в~шестнадцатеричном и~восьмеричном виде.

\end{enumerate}

\end{frame}

\section{Операции над  целыми числами}
...
Представьте вычисление выражения  в~виде последовательности двухадресных арифметических операций (\lstinline!+=, -=, /=, *=! и~т.\,д.)
\begin{enumerate}
\item $y = 1 + x + x^2 + x^3$
\item $y = (1 - x)(1+x+x^2)$
\item  $y = 1 + \frac{x^2 - 4}{2x + 2}$
\end{enumerate}
...
\setlength{\leftmargini}{0ex}
\begin{enumerate}
% \item Представьте число $19$ в~двоичном, шестнадцатеричном и~восьмеричном виде.
% \item Представьте число $-3$ в~дополнительном коде.
\item Рассчитайте $19 + (-3)$.
\item Рассчитайте $3 \And (-2)$.
\item Рассчитайте $5 \Or 3$.
...
\subsection{Нормализованное представление вещественного числа}
\begin{frame}{\insertsubsection}
\begin{equation*}
X = (-1)^{s} \cdot N^{p} \cdot \mu, 
\end{equation*}
\begin{equation*}
s \in \{0, 1\}, p \in \Integerset, ~ 0,1_N \leqslant \mu < 1
\end{equation*}
...
\subsection{Значения с~плавающей запятой (IEEE~754)}
\begin{frame}{\insertsubsection}
...
%   \real[nextm]{s}{111\ldots111}{000\ldots 0}{	\pm \infty	}
  \real[nextm]{x}{111\ldots111}{q x x\ldots x}{NaN}
...
Вещественные:
float, \textbf{double}, long double
...
% \section{Головная функция stdlib}
% 
% \begin{frame}{\insertsection}
% 
% \lstinline$int main()$ 

...
Если посмотреть на персональный компьютер, то он, как правило, состоит из \termin{системного блока} и~\termin{внешних устройств,} среди которых обязательно присутствуют устройства ввода-вывода, предназначенные для взаимодействия с~пользователем "--- экран, клавиатура, мышь и~т.\,д.

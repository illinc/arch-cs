...
\node[block, text width=42ex, above=2\ndist of uvv_box] (uvv_common) {Устройства ввода-вывода};
...
\node[block, left = 2\ndist of addr_south|-cpu.west] (ram)  {Оперативная память};
...
\node[block, above = 2\ndist of power_comment-|rightblocks_west, anchor=south west] (clock)  {Тактовый генератор};
\node[block, left = 2\ndist of addr_south|-clock] (bios)  {Постоянное запоминающее устройство};
